...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nwb/node_modules/nwb/lib/commands/serve.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nwb/node_modules/nwb/lib/commands/serve.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nwb/node_modules/nwb/lib/commands/</a> &#187; serve.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function serve(args, cb) {</span>
<span class="cstat-no" title="statement not covered" >  var userConfig = (0, _getUserConfig2.default)(args, { required: true });</span>
<span class="cstat-no" title="statement not covered" >  if (!SERVE_COMMANDS[userConfig.type]) {</span>
<span class="cstat-no" title="statement not covered" >    return cb(new _errors.UserError(`Unable to serve anything for a ${userConfig.type} project.`));</span>
  }
<span class="cstat-no" title="statement not covered" >  SERVE_COMMANDS[userConfig.type](args, cb);</span>
}
